...
Before implementing our methodology, 
the programs required to pass a final exam in a subject introducing OOP
used to consist of only one or two classes, 
...
Moreover, metrics from 2017 show that 88\% of the students that started the course took the final exam,
