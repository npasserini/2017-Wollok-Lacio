...
By focusing on quick visualization and a proper understanding of their mistakes,
...
\label{sec:testing}
As we described in \secref{problem}, Wollok provides two ways of working with the defined objects and classes: the REPL and the definition of tests.
