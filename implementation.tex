...
an editor capable of syntax and error highlighting (\figref{check-noMethodOnThis.png}), 
basic content-assist (\figref{codetemplates.png}) and cross-references search, 
