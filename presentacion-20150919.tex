...
\frame{
	...
	\begin{itemize}
		...
		\item \textbf{Estáticos}
			\begin{itemize}
			  \item \textbf{Checkeos}: XPect  % SCREEN: ACA MOSTRAMOS UN TEXT XPECT
...
% 	\begin{center}
% 		\begin{figure}
% 			\includegraphics[width=1\textwidth,height=1\textheight,natwidth=800,natheight=561]{images/wollok-wisit-sublime-syntax.eps}
% 			\hfill
% 			\includegraphics[width=1\textwidth,height=1\textheight,natwidth=800,natheight=558]{images/wollok-wisit-sublime-linter.eps}
% 		\end{figure}
% 	\end{center}
}
