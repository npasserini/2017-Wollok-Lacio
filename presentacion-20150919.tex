...
\frame{
	...
	\begin{center}
		\begin{figure}
			\includegraphics[width=0.6\textwidth,height=0.6\textheight,natwidth=1288,natheight=1056]{images/wollok-game-sokoban.png}
		\end{figure}
	\end{center}
}
...
\frame{
	...
	Los alumnos apropian intuitivamente las herramientas
	\begin{itemize}
