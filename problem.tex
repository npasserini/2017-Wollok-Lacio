...
To get this program running, the student has to walk through a minefield of packages, classes, scoping, types, arrays and class methods among others, 
and still he is not able to do more basic OO programming, such as sending a message to an object.
...
He states that earlier introductory courses focused on the development of algorithms in procedural or functional languages. 
