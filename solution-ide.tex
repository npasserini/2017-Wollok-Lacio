...
%Fig. \ref{fig:test} shows a sample Wollok test and Fig. \ref{fig:testRunner.png} shows the test runner tool ouput.
...
%\np{Provisorio, hay que revisar qué queremos decir exactamente.}

Finally, we remark that by the combination of REPL and tests, we have succeeded in completely avoiding the need for undesired debugging practices, such as the inclusion of \code{println} expressions along the code.
