...
- Detalles del REPL que no contamos antes: distingue mensajes con y sin efecto, admite variables con scope = sesión de REPL.
- Vista del resultado de la ejecución de tests.
