...
% Effect
Finally, Wollok includes features that allow to discuss allow \emph{control of side effects} from an early stage in programming courses, to help make programmers aware of the potential side effects of each portion of code.
...
Moreover, methods not including a \texttt{return} expression are considered as void, \ie\ they do not yield a value and no operation can be applied to them. Furthermore, the REPL do not show any text as result of the evaluation of void methods, as can be seen in Fig.~\ref{fig:repl}.
\cl{esta frase hay que pulirla.}
