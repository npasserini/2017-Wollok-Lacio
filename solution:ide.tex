...
Also, inline error reports, \eg underlining the offending code, relieves the student from the task of mapping the detected problem with the possible cause (\cf fig:errorReporting). 

Third, propose solutions.

La detección de errores quitan carga de trabajo al maestro.
Permiten no explicar determinados temas.

The next topic in helping novice programmers in leearning how to program is 
