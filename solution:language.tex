...
Also it shows the usage of more advanced list messages and closures\footnote{Our pedagogical method suggests to introduce polymorphism and closures \emph{before} classes. For reasons of space we removed intermediate examples here}.
