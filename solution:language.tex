...
One step forward is to incorporate an \emph{effect system} \cite{effect_system}, \cf Sec. \ref{sec:furtherWork}.
...
the belief that using objects or collections is far more complicated than using numbers or strings, which in turns leads to \emph{primitive obsession} \cite{primitive_obsession}.
